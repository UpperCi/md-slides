...
inline._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~';
inline.punctuation = (0, _helpers.edit)(inline.punctuation).replace(/punctuation/g, inline._punctuation).getRegex(); // sequences em should skip over [title](link), `code`, <html>
...
inline.reflink = (0, _helpers.edit)(inline.reflink).replace('label', inline._label).getRegex();
